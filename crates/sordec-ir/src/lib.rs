...
pub use high::{
    ...
    EnumKey, Expr, HighBlock, HighFunction, HighIr, IrType, KnownOp, KnownTier, KnownType, Literal,
    MapOpKind, MemWidth, PrngOpKind, Region, SemanticOp, StorageTier, TestOpKind, UnaryOp,
