//! Corpus tests — every committed contract in `samples/contracts/`
//! must satisfy the basic six assertions defined in
//! `common::assert_corpus_fixture`.
//!
...
// ---------------------------------------------------------------------
// Committed corpus fixtures under `samples/contracts/`.
// ---------------------------------------------------------------------
